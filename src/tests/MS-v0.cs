...
namespace DaJet.Data.Messaging.Test
{
    [TestClass] public class MS_v0
    {
        ...
        public MS_v0()
        {
            ...
            _infoBase = infoBase;
            _incomingQueue = _infoBase.GetApplicationObjectByName("РегистрСведений.ВходящаяОчередьRabbitMQ");
            _outgoingQueue = _infoBase.GetApplicationObjectByName("РегистрСведений.ИсходящаяОчередьRabbitMQ");
        }
